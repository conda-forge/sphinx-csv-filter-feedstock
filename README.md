...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sphinx-csv-filter-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14680&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sphinx-csv-filter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sphinx-csv-filter` can be installed with:

```
conda install sphinx-csv-filter
```

It is possible to list all of the versions of `sphinx-csv-filter` available on your platform with:
